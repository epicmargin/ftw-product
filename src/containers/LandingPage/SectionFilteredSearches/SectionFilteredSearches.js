...
import imageForFilter1 from './images/image-video.jpg';
import imageForFilter2 from './images/image-art.jpg';
import imageForFilter3 from './images/image-interior.jpg';
    ...
    <div className={classes}>
      ...
      <div className={css.filteredSearches}>
        <FilterLink
          ...
          link="http://localhost:3000/s?pub_brand=video_graphy"
        />
        <FilterLink
          name="Fine Artists"
          image={imageForFilter2}
          link="http://localhost:3000/s?pub_brand=fine_art"
        />
        <FilterLink
          name="Interior Designer"
          image={imageForFilter3}
          link="http://localhost:3000/s?pub_brand=interior"
        />
      </div>
    </div>
  );
